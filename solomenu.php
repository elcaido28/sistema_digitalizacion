                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="digitalizar_capacitaciones.php" data-ajax="false"><i class="fa fa-angle-double-right"></i>Capacitaciones</a></li>
                            <li><a href="digitalizar_certificados.php" data-ajax="false"><i class="fa fa-angle-double-right"></i>Certificados</a></li>
                            <li><a href="digitalizar_convenios.php" data-ajax="false"><i class="fa fa-angle-double-right"></i>Convenios</a></li>
                            ...
                            <li><a href="digitalizar_proyectos.php" data-ajax="false"><i class="fa fa-angle-double-right"></i>Proyectos</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="busqueda_digitalizacion.php" data-ajax="false"><i class="fa fa-angle-double-right"></i>Busqueda Digitalizacion</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="backupPHP/descargar.php" data-ajax="false"><i class="fa fa-angle-double-right"></i>Respaldar B.D. </a></li>
