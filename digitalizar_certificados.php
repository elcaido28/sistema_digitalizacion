                ...
                <section class="content">
                    ...
                    <div id="formu" class="contenedor-formularios">
                        <div class="contenido_tab_mod" id="contenido_tab">
                                <form action="guardar_digita_certificado.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="fila-arriba">
                                        ...
                                        <div class="contenedor-input">
                                            ...
                                            <select id="cajas" name="tipo_entidad" class="input-style">
                                                ...
                                                <?php 
                                                    $cons="SELECT * FROM entidades WHERE enti_id>=5 AND enti_id<=6 ORDER BY enti_id DESC";
                                    ...
                                    <div class="fila-arriba">
                                        <div class="contenedor-input">
                                            ...
                                            <input type="text" id="cajas" name="numero_curso" class="input-style" maxlength="10" required >
                                        </div>
                                        <div class="contenedor-input">
                                            <label class="label-style">
                                    ...
                                    <div class="fila-arriba">
                                        <div class="contenedor-input">
                                            ...
                                            <input type="text" name="capacitador" class="input-style"  required >
                                        </div>
                                        <div class="contenedor-input">
                                            <label class="label-style active">
                                    ...
                                    <div class="fila-arriba">
                                        ...
                                        <div class="contenedor-input">
                                            ...
                                            <input type="text" name="descripcion" class="input-style" required >
                                        </div>
                                    </div>
                        ...
                        <div class="content_table">
                            ...
                            <table class="tabla">
                                ...
                                <tr>
                                    <?php 
                                        $cons2="SELECT * FROM digitalizacion WHERE td_id = 2";
                                    ...
                                    <td><div class="optabla2">
                                        <a href="editar_certificado.php?id=<?php echo $row2['digi_id']; ?>" title="Editar"><i class="fas fa-pencil-alt esp-right"></i></a>
